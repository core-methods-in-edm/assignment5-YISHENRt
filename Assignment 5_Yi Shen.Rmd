...
## Part I
```{r}
D1 <- read.csv("Users/rita/assignment5-YISHENRt/intelligent_tutor.csv",header=TRUE)
```
...
D2 <- read.csv("/Users/rita/assignment5-YISHENRt/intelligent_tutor_new.csv",header=TRUE)
